...
> = {
  "no-anomalies": {
    ...
    description: "No anomalies detected. Energy usage is operating within expected thresholds.",
    accent: "#10b981",
  ...
  "no-data": {
    ...
    description: "No data found for the selected time range or filters. Try adjusting your selection.",
    accent: "#3b82f6",
  ...
  "loading-slow": {
    ...
    description: "The server is responding slowly. Please wait a moment or check your connection.",
    accent: "#f59e0b",
  ...
  "api-error": {
    ...
    description: "Unable to fetch data from the server. Please try again shortly.",
    accent: "#ef4444",
  ...
  "no-results": {
    ...
    description: "Your search didn't match any records. Try different keywords or filters.",
    accent: "#8b5cf6",
...
with open(r'components/dashboard/empty-state.tsx', 'w', encoding='utf-8', newline='\n') as f:
    f.write(content)
